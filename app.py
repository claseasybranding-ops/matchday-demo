...
def init_db():
    ...
    # Sørg for at poeng-kolonner finnes i fixtures
    try:
        c.execute("ALTER TABLE fixtures ADD COLUMN h_score INTEGER")
        c.execute("ALTER TABLE fixtures ADD COLUMN b_score INTEGER")
    except: pass
